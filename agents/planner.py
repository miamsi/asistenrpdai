...
def generate_plan(user_query: str, state: dict) -> tuple:
    """
    ...
    # Contoh pendeteksian kalimat: "pindahkan 53 ke bulan Maret dan Juni" atau "minta belanja 53 di bulan APR"
    ...
    if "53" in user_query and found_months:
        ...
        # Set bobot yang sama untuk setiap bulan yang disebutkan dalam teks obrolan sandbox
